...
test("reviews, comments, workflow_run, bots, push opt-in", () => {
  ...
  const p = mapGithubWebhook("push", { repository: repo, ref: "refs/heads/main", pusher: { name: "jordandru" }, commits: [{ id: "abcdef1234567890", message: "m", timestamp: "2026-08-16T14:00:00Z", author: { email: "j@x", name: "J" }, added: ["a.ts"], modified: [], removed: [] }] }, { includePush: true });
