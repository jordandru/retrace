...
export async function verifyExportBundle(bundle: ExportBundle, trustedPublicKey?: JsonWebKey, vopts?: { producers?: ProducerKey[]; trustedHookStamps?: readonly string[]; project?: string }): Promise<ExportVerdict> {
