...
Deployed: Worker version `c2bea8d8-6d31-42df-9834-23afbeee5b20` on 2026-08-30 (`a8bb994` — unverifiable caused_by sealed with `caused_by:unverified`; prior `3f86e8d0` signed full export VALID 807/807). Claude Code, Codex, Gemini CLI, Grok, and GitHub Copilot now have separate scoped identities, and the git-hook credential allows commits from all five.
