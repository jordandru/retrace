...
Deployed: Worker version `5b7ecdd6-1bf2-4126-95aa-979de90a0492` on 2026-08-30 (`710d478` — caused_by exists/same-project at write; prior `3f86e8d0` signed full export VALID 807/807). Claude Code, Codex, Gemini CLI, Grok, and GitHub Copilot now have separate scoped identities, and the git-hook credential allows commits from all five.
