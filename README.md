...
Deployed: Worker version `30c472e3-395e-4a7b-be5f-6a413b446908` on 2026-08-30 (`5f8c881` — router hardening plus `hash_v: 2` seals from `956cc68`; prior `3d8edca8` sealed_by stamp, `ee4863a3` received_at in hash). Claude Code, Codex, Gemini CLI, Grok, and GitHub Copilot now have separate scoped identities, and the git-hook credential allows commits from all five.
