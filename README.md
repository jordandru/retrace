...
Deployed: Worker version `ee4863a3-321f-45bf-9617-b4703f1b95e6` on 2026-08-30 (`46704a2` — `received_at` hash-covered on new seals; prior `3f86e8d0` signed full export VALID 807/807). Claude Code, Codex, Gemini CLI, Grok, and GitHub Copilot now have separate scoped identities, and the git-hook credential allows commits from all five.
