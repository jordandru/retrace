...
Deployed: Worker version `649243a7-a304-4bfb-b3db-f99447f6611d` on 2026-08-28; schema compatibility verified against all 44 fields/verbs. Claude Code, Codex, Gemini CLI, and Grok now have separate scoped identities, and the git-hook credential allows commits from all four.
