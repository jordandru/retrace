...
Deployed: Worker version `20d3e898-ab54-485a-bc94-fd5df413e644` on 2026-08-29 (adapter idempotency-prefix reservation, 1bc76c1; Drive `caused_by` mapper). Claude Code, Codex, Gemini CLI, Grok, and GitHub Copilot now have separate scoped identities, and the git-hook credential allows commits from all five.
