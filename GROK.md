...
- Seat: measurer (`docs/team-roles.md`). When the coordinator is capped, substitute spec author
  / incident architect if Jordan or a recorded routing event says so — never coordinator or merger.
